  ...
  ngOnInit(): void {
    this.experiencia = [
      ...
      },
      {
        ...
        "tecnologías": ["PHP (Laravel)", "Angular", "WordPress", "HTML & CSS", "TypeScript"]
      }
    ]
  }
}
